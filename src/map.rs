...
use crate::mapbox::pmtile::BinarySlice;
use crate::mapbox::pmtile::Renderer;
use crate::mapbox::read_one_linestring;
...
pub fn compile_tile<R: Renderer>(font: &mut FontMetric, x: u64, y: u64, z: u8, reader: BinarySlice) -> Result<Tile<R>, String> {
    let mut raw_tile = read_one_linestring(&mut Message::new(reader)).unwrap();
